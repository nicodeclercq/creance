...
function getHalfDaysCount(period: {
  start: Date;
  end: Date;
  arrival: "AM" | "PM";
  departure: "AM" | "PM";
  ...
  return daysCount * 2 + arrivalOffset + departureOffset;
}

function getDefaultUserShareCount(
  period: {
    start: Date;
    end: Date;
    arrival: "AM" | "PM";
...
export function getEventShares(
  ...
  return pipe(
    Object.values(event.receivables),
    (expenses) =>
