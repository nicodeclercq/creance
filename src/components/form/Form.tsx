...
import { useForm, FieldName, Controller, FieldError, FieldValues, DeepPartial } from 'react-hook-form';
...
const actionsStyle = css({
  ...
  width: '100%',
  padding: `${VAR.SIZE.PADDING.M.VERTICAL} ${VAR.SIZE.PADDING.M.HORIZONTAL}`,
  ...
  return (
    <form onSubmit={submitHandler}>
      <div className={styles}>
        {
          Record.toEntries(fields).map(([name, value]) => (<React.Fragment key={name as string}>
