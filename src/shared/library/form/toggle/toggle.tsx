...
export function Toggle({ id, disabled = false, checked = false, onChange }: Props) {
  ...
  return (
    <label htmlFor={_id} className="s-toggle">
      <input type="checkbox" id={_id} disabled={disabled} defaultChecked={currentValue} onClick={() => onValueChange(!currentValue)}/>
